    ...
    private void init(@Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            try { //Parse params
                ...
                if (a.hasValue(R.styleable.RulerValuePicker_min_value_ruler) ||
                        a.hasValue(R.styleable.RulerValuePicker_max_value_ruler)) {
                    setMinMaxValue(a.getInteger(R.styleable.RulerValuePicker_min_value_ruler, 0),
                            a.getInteger(R.styleable.RulerValuePicker_max_value_ruler, 100));
                }
            } finally {
                a.recycle();
            }
